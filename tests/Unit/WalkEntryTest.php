...
describe('WalkEntry::getWeeklyStats', function () {
    it('returns zero stats when no entries exist', function () {
        $stats = WalkEntry::getWeeklyStats();
    ...
    it('calculates weekly stats correctly', function () {
        WalkEntry::create(['distance_miles' => 2, 'steps' => 4000, 'date' => '2026-02-15']);
        WalkEntry::create(['distance_miles' => 3, 'steps' => 6000, 'date' => '2026-02-16']);
        WalkEntry::create(['distance_miles' => 1.5, 'steps' => 3000, 'date' => '2026-02-17']);
    ...
    it('only includes entries from last 7 days', function () {
        ...
        WalkEntry::create(['distance_miles' => 10, 'steps' => 20000, 'date' => '2026-02-09']);
        // Today - inside window
...
describe('WalkEntry::getChartData', function () {
    it('returns correct structure for chart data', function () {
        ...
        $chart = WalkEntry::getChartData(7);
    ...
    it('fills missing days with zero distance', function () {
        $chart = WalkEntry::getChartData(3);
